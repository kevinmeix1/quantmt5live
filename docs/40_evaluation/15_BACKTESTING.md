...
4. Check market quality.
5. Let the strategy propose a request.
6. Let risk approve, shrink, or block the request.
7. If approved, simulate a fill using bid/ask plus slippage.
8. Update cash, position units, and equity.
9. Save an equity-curve point.
