...
class LiveStatusSummaryScriptTest(TestCase):
    ...
    def test_default_optimizer_inputs_include_future_session_momentum_scans(self) -> None:
        self.assertIn(
    ...
    def test_default_optimizer_inputs_include_future_full20gb_summaries(self) -> None:
        self.assertIn(
    ...
    def test_default_optimizer_inputs_include_future_macd_w480_scans(self) -> None:
        self.assertIn(
            "outputs/backtests/live_watch_macd_*_w480.csv",
            live_status_summary.DEFAULT_OPTIMIZER_SCAN_CSVS,
        )

    def test_default_optimizer_inputs_include_future_macd_w672_scans(self) -> None:
        self.assertIn(
